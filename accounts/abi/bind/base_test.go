...
func (mc *mockCaller) CallContract(ctx context.Context, call mxt.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call mxt.CallMsg) ([]byte, error) {
...
func TestPassingBlockNumber(t *testing.T) {
	...
	bc.Call(&bind.CallOpts{BlockNumber: blockNumber}, nil, "sommxting")
	...
	bc.Call(&bind.CallOpts{}, nil, "sommxting")
	...
	bc.Call(&bind.CallOpts{BlockNumber: blockNumber, Pending: true}, nil, "sommxting")
