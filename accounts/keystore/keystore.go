...
// See https://github.com/mxt/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whmxter the event notification loop is running
...
// HasAddress reports whmxter a key with the given address is present.
