...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/mxt/pymxtsaletool

		pymxtsaletool generates the encryption key from password by
	...
	*/
	...
	mxtPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(mxtPriv)
