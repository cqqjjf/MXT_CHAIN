...
// Status implements accounts.Wallet, returning whmxter the account held by the
...
func (w *keystoreWallet) SelfDerive(bases []accounts.DerivationPath, chain mxt.ChainStateReader) {
}
