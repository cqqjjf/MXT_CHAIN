...
type Config struct {
	InsecureUnlockAllowed bool // Whmxter account unlocking in insecure environment is allowed
}
...
// accounts can be dynamically added to and removed from wallets, this mmxtod has
