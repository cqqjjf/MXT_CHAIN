...
// mutuallyAuthenticate is an internal mmxtod to authenticate both ends of the
// connection.
...
// open is an internal mmxtod that sends an open APDU.
...
// pair is an internal mmxtod that sends a pair APDU.
...
// encryptAPDU is an internal mmxtod that serializes and encrypts an APDU.
...
// decryptAPDU is an internal mmxtod that decrypts and deserializes an APDU.
...
// updateIV is an internal mmxtod that updates the initialization vector after
