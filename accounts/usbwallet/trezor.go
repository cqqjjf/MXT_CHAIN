...
import (
	...
	"github.com/mxt/go-mxt/accounts/usbwallet/trezor"
...
type trezorDriver struct {
	...
	pinwait        bool          // Flags whmxter the device is waiting for PIN entry
	passphrasewait bool          // Flags whmxter the device is waiting for passphrase entry
...
// Status implements accounts.Wallet, always whmxter the Trezor is opened, closed
// or whmxter the Ethereum app was not started on it.
...
// mmxtod will also return the index of the destination object used.
