...
// whmxter they are still present or if they malfunctioned.
...
// Contains implements accounts.Wallet, returning whmxter a particular account is
...
// supported for hardware wallets, so this mmxtod will always return an error.
...
// too old to sign EIP-155 transactions, but such is requested nonmxteless, an error
...
// data is not supported for Ledger wallets, so this mmxtod will always return
// an error.
