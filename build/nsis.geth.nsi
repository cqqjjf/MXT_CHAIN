...
# 1. install gmxt for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gmxt
# 5. create gmxt, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since gmxt is installed global
