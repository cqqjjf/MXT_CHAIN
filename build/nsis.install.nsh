Name "gmxt ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/mxt/go-mxt/issues"
!define UPDATEURL "https://github.com/mxt/go-mxt/releases"
!define ABOUTURL "https://github.com/mxt/go-mxt#mxt-go"
...
# Install gmxt binary
Section "Gmxt" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gmxt}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gmxt.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gmxt.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gmxt incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gmxt outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gmxt UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gmxt incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gmxt.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gmxt outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gmxt.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gmxt UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gmxt.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/mxt/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gmxt.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gmxt.ipc"
