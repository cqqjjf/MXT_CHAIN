...
// Suite represents a structure used to test the mxt
...
// NewSuite creates and returns a new mxt-test suite that can
...
// TestGetBlockHeaders tests whmxter the given node can respond to
...
// TestGetBlockBodies tests whmxter the given node can respond to
...
// TestBroadcast tests whmxter a block announcement is correctly
