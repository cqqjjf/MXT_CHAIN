...
var (
	walletCommand = cli.Command{
		...
		Description: `
    gmxt wallet import /path/to/my/presale.wallet

will prompt for your password and imports your mxter presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	gmxt wallet [options] /path/to/my/presale.wallet
...
between mxt nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gmxt account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gmxt account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another mxt instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gmxtConfig{Node: defaultNodeConfig()}
	// Load config file.
