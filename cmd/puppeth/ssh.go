...
// sshClient is a small wrapper around Go's SSH client with a few utility mmxtods
// implemented on top.
...
func dial(server string, pubkey []byte) (*sshClient, error) {
	...
	// Configure the supported authentication mmxtods (private key and password)
	var auths []ssh.AuthMmxtod
...
// capable of acting as puppmxt target.
