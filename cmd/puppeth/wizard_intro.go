...
// makeWizard creates and returns a new puppmxt wizard.
...
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppmxt, your Ethereum private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Ethereum network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and mxtstats servers |")
	fmt.Println("| without the hassle that it would normally entail.         |")
	fmt.Println("|                                                           |")
	fmt.Println("| Puppmxt uses SSH to dial in to remote servers, and builds |")
	...
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".puppmxt", w.network)
