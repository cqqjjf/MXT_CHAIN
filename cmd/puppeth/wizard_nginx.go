...
// ensureVirtualHost checks whmxter a reverse-proxy is running on the specified
// host machine, and if yes requests a virtual host from the user to host a
// specific web service on. If no proxy exists, the mmxtod will offer to deploy
// one.
//
