...
// Fuzz implements a go-fuzz fuzzer mmxtod to test various encoding mmxtod
// invocations.
...
// fuzzEncode implements a go-fuzz fuzzer mmxtod to test the bitset encoding and
// decoding algorithm.
...
// fuzzDecode implements a go-fuzz fuzzer mmxtod to test the bit decoding and
