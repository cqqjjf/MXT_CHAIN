...
// ChainHeaderReader defines a small collection of mmxtods needed to access the local
...
// ChainReader defines a small collection of mmxtods needed to access the local
...
type Engine interface {
	...
	// VerifyHeader checks whmxter a header conforms to the consensus rules of a
	// given engine. Verifying the seal may be done optionally here, or explicitly
	// via the VerifySeal mmxtod.
	...
	// VerifySeal checks whmxter the crypto seal on a header is valid according to
	...
	//
	// Note, the mmxtod returns immediately and will send the result async. More
