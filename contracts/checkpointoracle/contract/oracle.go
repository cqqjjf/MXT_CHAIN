...
type CheckpointOracleRaw struct {
	Contract *CheckpointOracle // Generic contract binding to access the raw mmxtods on
}
...
type CheckpointOracleCallerRaw struct {
	Contract *CheckpointOracleCaller // Generic read-only contract binding to access the raw mmxtods on
}
...
type CheckpointOracleTransactorRaw struct {
	Contract *CheckpointOracleTransactor // Generic write-only contract binding to access the raw mmxtods on
}
...
// returns.
func (_CheckpointOracle *CheckpointOracleRaw) Call(opts *bind.CallOpts, result *[]interface{}, mmxtod string, params ...interface{}) error {
	return _CheckpointOracle.Contract.CheckpointOracleCaller.contract.Call(opts, result, mmxtod, params...)
}
...
func (_CheckpointOracle *CheckpointOracleRaw) Transact(opts *bind.TransactOpts, mmxtod string, params ...interface{}) (*types.Transaction, error) {
	return _CheckpointOracle.Contract.CheckpointOracleTransactor.contract.Transact(opts, mmxtod, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_CheckpointOracle *CheckpointOracleCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, mmxtod string, params ...interface{}) error {
	return _CheckpointOracle.Contract.contract.Call(opts, result, mmxtod, params...)
}
...
// Transact invokes the (paid) contract mmxtod with params as input values.
func (_CheckpointOracle *CheckpointOracleTransactorRaw) Transact(opts *bind.TransactOpts, mmxtod string, params ...interface{}) (*types.Transaction, error) {
	return _CheckpointOracle.Contract.contract.Transact(opts, mmxtod, params...)
}

// GetAllAdmin is a free data retrieval call binding the contract mmxtod 0x45848dfc.
//
...
// GetLatestCheckpoint is a free data retrieval call binding the contract mmxtod 0x4d6a304c.
//
...
// SetCheckpoint is a paid mutator transaction binding the contract mmxtod 0xd459fc46.
//
