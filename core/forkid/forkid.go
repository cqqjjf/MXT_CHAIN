...
// Package forkid implements EIP-2124 (https://eips.mxt.org/EIPS/eip-2124).
package forkid
...
// Blockchain defines all necessary mmxtod to build a forkID.
...
func newFilter(config *params.ChainConfig, genesis common.Hash, headfn func() uint64) Filter {
	...
	return func(id ID) error {
		...
		return nil // Sommxting's very wrong, accept rather than reject
	}
}
