...
func ReadDatabaseVersion(db mxtdb.KeyValueReader) *uint64 {
	var version uint64
...
func WriteDatabaseVersion(db mxtdb.KeyValueWriter, version uint64) {
...
func ReadChainConfig(db mxtdb.KeyValueReader, hash common.Hash) *params.ChainConfig {
...
func WriteChainConfig(db mxtdb.KeyValueWriter, hash common.Hash, cfg *params.ChainConfig) {
	if cfg == nil {
		return
	}
