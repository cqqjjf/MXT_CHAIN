...
//   reserving it for go-mxt. This would also reduce the memory requirements
//   of Gmxt, and thus also GC overhead.
type freezer struct {
...
// HasAncient returns an indicator whmxter the specified ancient data exists
// in the freezer.
...
func (f *freezer) freeze(db mxtdb.KeyValueStore) {
	...
	for {
		...
		// Log sommxting friendly for the user
		context := []interface{}{
