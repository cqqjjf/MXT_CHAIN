...
var (
	...
	// lastPivotKey tracks the last pivot block used by fast sync (to reenable on smxtead).
	...
	configPrefix   = []byte("mxt-config-") // config prefix for the db
...
// freezerNoSnappy configures whmxter compression is disabled for the ancient-tables.
...
// IsCodeKey reports whmxter the given byte slice is the key of contract code,
