...
func NewTable(db mxtdb.Database, prefix string) mxtdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) mxtdb.Iterator {
...
func (t *table) NewBatch() mxtdb.Batch {
...
func (b *tableBatch) Replay(w mxtdb.KeyValueWriter) error {
