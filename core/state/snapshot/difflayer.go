...
// newDiffLayer creates a new diff on top of an existing snapshot, whmxter that's a low
...
// Stale return whmxter this layer has become stale (was flattened across) or if
// it's still live.
...
func (dl *diffLayer) AccountRLP(hash common.Hash) ([]byte, error) {
	// Check the bloom filter first whmxter there's even a point in reaching into
...
func (dl *diffLayer) flatten() snapshot {
	...
	// be smarter about grouping flattens togmxter).
