...
// Account returns the RLP encoded slim account the iterator is currently at.
// This mmxtod may _fail_, if the underlying layer has been flattened between
// the call to Next and Acccount. That type of error will set it.Err.
// This mmxtod assumes that flattening does not delete elements from
...
// iterated without error, so this mmxtod always returns nil.
