...
type stateObject struct {
	...
	addrHash common.Hash // hash of mxt address of the account
	data     Account
	db       *StateDB
...
// empty returns whmxter the account is considered empty.
...
// or zero if none. This mmxtod is an almost mirror of Code, but uses a cache
