...
// StateDB structs within the mxt protocol are used to store anything
...
// This mmxtod will panic if the refund counter goes below zero
...
// Exist reports whmxter the given account address exists in the state.
// Notably this also returns true for suicided accounts.
func (s *StateDB) Exist(addr common.Address) bool {
	return s.getStateObject(addr) != nil
}

// Empty returns whmxter the state object is either non-existent
...
//
// Setting, updating & deleting state object mmxtods.
//
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/mxt/go-mxt/pull/16485#issuecomment-380438527),
		// and in the Finalise-mmxtod, there is a case where an object is in the journal but not
