...
// account array.
func checkStateAccounts(t *testing.T, db mxtdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db mxtdb.Database, root common.Hash) error {
...
func checkStateConsistency(db mxtdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	// isCode reports whmxter the hash is contract code hash.
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(mxtdb.Database), srcRoot)
