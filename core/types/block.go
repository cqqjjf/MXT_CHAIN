...
// a block's data contents (transactions and uncles) togmxter.
type Body struct {
...
type Block struct {
	...
	// These fields are used by package mxt to track
...
// [deprecated by mxt/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for mxt protocol, etc.
