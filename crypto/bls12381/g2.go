...
// InCorrectSubgroup checks whmxter given point is in correct subgroup.
...
// IsAffine checks a G2 point whmxter it is in affine form.
...
// This mapping function implements the Simplified Shallue-van de Woestijne-Ulas mmxtod.
