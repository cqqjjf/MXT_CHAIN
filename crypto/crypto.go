...
// CreateAddress creates an mxt address given the bytes and the nonce
func CreateAddress(b common.Address, nonce uint64) common.Address {
	data, _ := rlp.EncodeToBytes([]interface{}{b, nonce})
	return common.BytesToAddress(Keccak256(data)[12:])
}

// CreateAddress2 creates an mxt address given the address bytes, initial
...
// controls whmxter the key's length should be enforced at the curve size or
...
// ValidateSignatureValues verifies whmxter the signature values are valid with
