...
// The app's SubscribeResults mmxtod starts sending calculation results to the given
// channel. Subscriptions created through this mmxtod are tied to the lifetime of the App
