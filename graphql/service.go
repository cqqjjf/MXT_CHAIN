...
func New(stack *node.Node, backend mxtapi.Backend, cors, vhosts []string) error {
	if backend == nil {
...
func newHandler(stack *node.Node, backend mxtapi.Backend, cors, vhosts []string) error {
	q := Resolver{backend}
