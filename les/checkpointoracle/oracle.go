...
type CheckpointOracle struct {
	...
	running  int32                                 // Flag whmxter the contract backend is set or not
...
// IsRunning returns an indicator whmxter the oracle is running.
...
// checks whmxter there are enough approvals to finalize the checkpoint.
