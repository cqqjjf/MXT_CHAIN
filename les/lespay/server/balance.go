...
// checkCallbacks checks whmxter the threshold of any of the active callbacks
...
// checkPriorityStatus checks whmxter the node has gained priority status and sets the priority
