...
func NewBalanceTracker(ns *nodestate.NodeStateMachine, setup BalanceTrackerSetup, db mxtdb.KeyValueStore, clock mclock.Clock, posExp, negExp utils.ValueExpirer) *BalanceTracker {
...
// canDropBalance tells whmxter a positive or negative balance is below the threshold
