...
// RequestCapacity checks whmxter changing the capacity of a node to the given target
...
// the minimum priority needed to do the change and whmxter it is currently allowed.
