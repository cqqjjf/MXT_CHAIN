...
type accessTestFn func(db mxtdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }
func TestBlockAccessLes3(t *testing.T) { testAccess(t, 3, tfBlockAccess) }

func tfBlockAccess(db mxtdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db mxtdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db mxtdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db mxtdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
