...
func TestNodeIterator(t *testing.T) {
	...
	blockchain, _ := core.NewBlockChain(fulldb, nil, params.TestChainConfig, mxtash.NewFullFaker(), vm.Config{}, nil, nil)
	gchain, _ := core.GenerateChain(params.TestChainConfig, genesis, mxtash.NewFaker(), fulldb, 4, testChainGen)
