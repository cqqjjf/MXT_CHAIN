...
import (
	...
	"github.com/mxt/go-mxt/metrics/prommxteus"
)
...
func Exp(r metrics.Registry) {
	...
	http.Handle("/debug/metrics/prommxteus", prommxteus.Handler(r))
}
...
func Setup(address string) {
	...
	m.Handle("/debug/metrics/prommxteus", prommxteus.Handler(metrics.DefaultRegistry))
