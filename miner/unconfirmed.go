...
// chainRetriever is used by the unconfirmed block set to verify whmxter a previously
...
func (set *unconfirmedBlocks) Shift(height uint64) {
	...
	for set.blocks != nil {
		...
		default:
			// Block is not canonical, check whmxter we have an uncle or a lost block
			included := false
