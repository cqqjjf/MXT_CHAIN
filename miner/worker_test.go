...
var (
	...
	mxtashChainConfig *params.ChainConfig
...
func init() {
	...
	mxtashChainConfig = params.TestChainConfig
...
func newTestWorkerBackend(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db mxtdb.Database, n int) *testWorkerBackend {
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db mxtdb.Database, blocks int) (*worker, *testWorkerBackend) {
...
func TestEmptyWorkEthash(t *testing.T) {
	testEmptyWork(t, mxtashChainConfig, mxtash.NewFaker())
}
...
func TestStreamUncleBlock(t *testing.T) {
	mxtash := mxtash.NewFaker()
	defer mxtash.Close()

	w, b := newTestWorker(t, mxtashChainConfig, mxtash, rawdb.NewMemoryDatabase(), 1)
	defer w.close()
...
func TestRegenerateMiningBlockEthash(t *testing.T) {
	testRegenerateMiningBlock(t, mxtashChainConfig, mxtash.NewFaker())
}
...
func TestAdjustIntervalEthash(t *testing.T) {
	testAdjustInterval(t, mxtashChainConfig, mxtash.NewFaker())
}
