...
// It offers only mmxtods that operates on data that can be available to anyone without security risks.
...
type SyncingResult struct {
	...
	Status  mxt.SyncProgress `json:"status"`
}
