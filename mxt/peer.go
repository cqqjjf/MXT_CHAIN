...
//
// This mmxtod is legacy support for initial transaction exchange in mxt/64 and
// prior. For mxt/65 and higher use SendPooledTransactionHashes.
...
// in its transaction hash set for future reference.
//
// This mmxtod is a helper used by the async transaction sender. Don't call it
...
//
// This mmxtod is a helper used by the async transaction announcer. Don't call it
// directly as the queueing (memory) and transmission (bandwidth) costs should
// not be managed directly.
...
//
// Note, the mmxtod assumes the hashes are correct and correspond to the list of
...
// Handshake executes the mxt protocol handshake, negotiating version number,
