...
const protocolName = "mxt"

// ProtocolVersions are the supported versions of the mxt protocol (first is primary).
var ProtocolVersions = []uint{mxt65, mxt64, mxt63}

// protocolLengths are the number of implemented message corresponding to different protocol versions.
var protocolLengths = map[uint]uint64{mxt65: 17, mxt64: 17, mxt63: 17}

const protocolMaxMsgSize = 10 * 1024 * 1024 // Maximum cap on the size of a protocol message

// mxt protocol message codes
const (
	StatusMsg          = 0x00
	...
	// New protocol message codes introduced in mxt65
	//
	// Previously these message ids were used by some legacy and unsupported
	// mxt protocols, reown them here.
...
// statusData63 is the network packet for the status message for mxt/63.
...
// statusData is the network packet for the status message for mxt/64 and later.
