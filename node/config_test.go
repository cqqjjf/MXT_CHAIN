...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gmxt.ipc", false, filepath.Join(os.TempDir(), "gmxt.ipc")},
		{"data", "gmxt.ipc", false, "data/gmxt.ipc"},
		{"data", "./gmxt.ipc", false, "./gmxt.ipc"},
		{"data", "/gmxt.ipc", false, "/gmxt.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gmxt.ipc", true, `\\.\pipe\gmxt.ipc`},
		{"data", "gmxt.ipc", true, `\\.\pipe\gmxt.ipc`},
		{"data", `\\.\pipe\gmxt.ipc`, true, `\\.\pipe\gmxt.ipc`},
	}
