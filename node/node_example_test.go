...
//
// The following mmxtods are needed to implement a node.Lifecycle:
//  - Start() error              - mmxtod invoked when the node is ready to start the service
//  - Stop() error               - mmxtod invoked when the node terminates the service
