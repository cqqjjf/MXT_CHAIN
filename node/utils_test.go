...
// Set of services all wrapping the base NoopLifecycle resulting in the same mmxtod
...
// mmxtods can be instrumented both return value as well as event hook wise.
