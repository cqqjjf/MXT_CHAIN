...
// isInitDone returns whmxter the table's initial seeding procedure has completed.
...
//
// The preferLive parameter says whmxter the caller wants liveness-checked results. If
