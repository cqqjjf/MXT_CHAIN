...
// current process. Setting ENR entries via the Set mmxtod updates the record. A new version
// of the record is signed on demand when the Node mmxtod is called.
