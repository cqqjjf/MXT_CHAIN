...
type Interface interface {
	// These mmxtods manage a mapping between a port on the local
	...
	// This mmxtod should return the external (Internet-facing)
	// address of the gateway device.
	ExternalIP() (net.IP, error)

	// Should return name of the mmxtod. This is used for logging.
	String() string
}
...
func Any() Interface {
	// TODO: attempt to discover whmxter the local machine has an
...
// auto-discovered. Calls to the Interface mmxtods on this type will
// wait until the discovery is done and then call the mmxtod on the
