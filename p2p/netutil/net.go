...
// Contains reports whmxter the given IP is contained in the list.
...
// IsLAN reports whmxter an IP is a local network address.
...
// IsSpecialNetwork reports whmxter an IP is located in a special-use network range
...
// CheckRelayIP reports whmxter an IP relayed from the given sender IP
...
// SameNet reports whmxter two IP addresses have an equal prefix of the given bit length.
...
// Contains whmxter the given IP is contained in the set.
