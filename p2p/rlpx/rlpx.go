...
import (
	...
	"github.com/mxt/go-mxt/crypto/ecies"
...
//
// Before sending messages, a handshake must be performed by calling the Handshake mmxtod.
...
// len(data) depending on whmxter snappy compression is enabled.
...
type authMsgV4 struct {
	gotPlain bool // whmxter read packet had plain format.
