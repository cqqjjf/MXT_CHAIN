...
const (
	...
	SstoreResetGasEIP2200             uint64 = 5000  // Once per SSTORE operation from clean non-zero to sommxting else
...
var (
	...
	DurationLimit          = big.NewInt(13)     // The decision boundary on the blocktime duration used to determine whmxter difficulty should go up or not.
)
