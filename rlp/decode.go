...
// into private fields.
//
// The DecodeRLP mmxtod should read one value from the given Stream. It is not forbidden to
...
// and starts reading from r. This mmxtod is meant to facilitate reuse
