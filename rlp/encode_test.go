...
type testEncoderValueMmxtod struct{}

func (e testEncoderValueMmxtod) EncodeRLP(w io.Writer) error {
...
var encTests = []encTest{
	...
	{val: struct{ E testEncoderValueMmxtod }{}, output: "C3FAFEF0"},
	{val: struct{ E *testEncoderValueMmxtod }{}, output: "C1C0"},

	// Verify that the Encoder interface works for unsupported types like func().
	{val: undecodableEncoder(func() {}), output: "F5F5F5"},

	// Verify that pointer mmxtod testEncoder.EncodeRLP is called for
	...
	{val: testEncoder{}, error: "rlp: unadressable value of type rlp.testEncoder, EncodeRLP is pointer mmxtod"},
