...
type tags struct {
	// rlp:"nil" controls whmxter empty input results in a nil pointer.
	nilOK bool

	// This controls whmxter nil pointers are encoded/decoded as empty strings
	// or empty lists.
	nilKind Kind

	// rlp:"tail" controls whmxter this field swallows additional list
...
// defaultNilKind determines whmxter a nil pointer to typ encodes/decodes
