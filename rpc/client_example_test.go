...
// known to the server. The server supports two mmxtods:
//
// mxt_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// mxt_subscribe("newHeads")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	var lastBlock Block
	err = client.CallContext(ctx, &lastBlock, "mxt_getBlockByNumber", "latest", false)
	if err != nil {
