...
func TestClientBatchRequest(t *testing.T) {
	...
	wantResult := []BatchElem{
		...
		},
		{
			...
			Args:   []interface{}{1, 2, 3},
			Result: new(int),
			Error:  &jsonError{Code: -32601, Message: "the mmxtod no_such_mmxtod does not exist/is not available"},
		},
	}
...
// This test reproduces https://github.com/mxt/go-mxt/issues/17837 where the
...
func TestClientReconnect(t *testing.T) {
	...
	// We spawn multiple calls here to check whmxter this hangs somehow.
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-mxt-test-ipc-%d-%d", os.Getpid(), rand.Int63())
