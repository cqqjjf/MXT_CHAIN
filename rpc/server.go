...
const (
	// OptionMmxtodInvocation is an indication that the codec supports RPC mmxtod calls
	OptionMmxtodInvocation CodecOption = 1 << iota
...
func NewServer() *Server {
	...
	// as the services and mmxtods it offers.
