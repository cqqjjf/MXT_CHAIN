...
// API describes the set of mmxtods offered over the RPC interface
type API struct {
	Namespace string      // namespace under which the rpc mmxtods of Service are exposed
	Version   string      // api version for DApp's
	Service   interface{} // receiver instance which holds the mmxtods
	Public    bool        // indication if the mmxtods must be considered safe for public use
}
