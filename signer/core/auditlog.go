...
func (l *AuditLogger) SignTransaction(ctx context.Context, args SendTxArgs, mmxtodSelector *string) (*mxtapi.SignTransactionResult, error) {
	sel := "<nil>"
	if mmxtodSelector != nil {
		sel = *mmxtodSelector
	}
	...
	res, e := l.api.SignTransaction(ctx, args, mmxtodSelector)
	if res != nil {
...
func (l *AuditLogger) SignGnosisSafeTx(ctx context.Context, addr common.MixedcaseAddress, gnosisTx GnosisSafeTx, mmxtodSelector *string) (*GnosisSafeTx, error) {
	sel := "<nil>"
	if mmxtodSelector != nil {
		sel = *mmxtodSelector
	}
	...
	res, e := l.api.SignGnosisSafeTx(ctx, addr, gnosisTx, mmxtodSelector)
	if res != nil {
