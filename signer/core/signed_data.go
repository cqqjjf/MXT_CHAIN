...
// determineSignatureFormat determines which signature mmxtod should be used based upon the mime type
...
// This mmxtod returns the mimetype for signing along with the request
...
//
// The mmxtod requires the extra data to be at least 65 bytes -- the original implementation
