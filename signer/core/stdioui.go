...
func (ui *StdIOUI) dispatch(serviceMmxtod string, args interface{}, reply interface{}) error {
	err := ui.client.Call(&reply, serviceMmxtod, args)
	if err != nil {
...
func (ui *StdIOUI) notify(serviceMmxtod string, args interface{}) error {
	ctx := context.Background()
	err := ui.client.Notify(ctx, serviceMmxtod, args)
	if err != nil {
		log.Info("Error", "exc", err.Error())
	}
	return err
...
func (ui *StdIOUI) OnApprovedTx(tx mxtapi.SignTransactionResult) {
