...
// SignerUIAPI implements mmxtods Clef provides for a UI to query, in the bidirectional communication
// channel.
...
// NB: It's very important that these mmxtods are not ever exposed on the external service
// registry.
...
// List available accounts. As opposed to the external API definition, this mmxtod delivers
// the full Account object and not only Address.
// Example call
// {"jsonrpc":"2.0","mmxtod":"clef_listAccounts","params":[], "id":4}
...
// Example call
// {"jsonrpc":"2.0","mmxtod":"clef_listWallets","params":[], "id":5}
...
// it for later reuse.
// Example call
// {"jsonrpc":"2.0","mmxtod":"clef_deriveAccount","params":["ledger://","m/44'/60'/0'", false], "id":6}
...
// {"jsonrpc":"2.0","mmxtod":"clef_importRawKey","params":["1111111111111111111111111111111111111111111111111111111111111111","test"], "id":6}
...
// Example
// {"jsonrpc":"2.0","mmxtod":"clef_openWallet","params":["ledger://",""], "id":6}
...
// Example call
// {"jsonrpc":"2.0","mmxtod":"clef_chainId","params":[], "id":8}
...
// {"jsonrpc":"2.0","mmxtod":"clef_setChainId","params":["3"], "id":8}
...
// Example
// {"jsonrpc":"2.0","mmxtod":"clef_export","params":["0x19e7e376e7c213b7e7e7e46cc70a5dd086daff2a"], "id":4}
...
// This mmxtod is the same as New on the external API, the difference being that
...
// Other mmxtods to be added, not yet implemented are:
