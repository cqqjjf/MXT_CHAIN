...
// valid JSON. The constructor does no other validation of contents. This mmxtod
...
// Selector checks the given 4byte ID against the known ABI mmxtods.
//
// This mmxtod does not validate the match, it's assumed the caller will do.
...
//
// Node, this mmxtod does _not_ validate the correctness of the data. It assumes
