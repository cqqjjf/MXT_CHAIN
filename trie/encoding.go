...
// 'terminator' byte of value 0x10 which indicates whmxter or not the node at the key
...
// the second-lowest encoding whmxter the node at the key is a value node. The low nibble
...
// hasTerm returns whmxter a hex key has the terminator flag.
